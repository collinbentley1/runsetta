...
class ViewController: UIViewController {
    ...
    lazy var configuration: SPTConfiguration = {
        ...
        configuration.tokenSwapURL = URL(string: "https://hypercoach-gai.cdbentley.com/api/token")
        configuration.tokenRefreshURL = URL(string: "https://hypercoach-gai.cdbentley.com/api/refresh_token")
