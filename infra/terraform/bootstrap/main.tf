module "bootstrap" {
  source = "github.com/collinbentley1/platform//terraform/modules/bootstrap?ref=0a4a52f94e7795fc42e54f1d4d304e052c33ca82"
  ...
  trusted_platform_workflow_shas = [
    "0a4a52f94e7795fc42e54f1d4d304e052c33ca82",
  ]
