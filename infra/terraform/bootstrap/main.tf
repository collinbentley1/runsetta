module "bootstrap" {
  source = "github.com/collinbentley1/platform//terraform/modules/bootstrap?ref=6e619a0f4123fc594c8cb4d7d857ecbd1a8d5643"
  ...
  trusted_platform_workflow_shas = [
    "6e619a0f4123fc594c8cb4d7d857ecbd1a8d5643",
  ]
  required_services = [
