module "bootstrap" {
  source = "github.com/collinbentley1/platform//terraform/modules/bootstrap?ref=625efd11af9fd3b7f4d0ca972475173d5b25a472"
  ...
  trusted_platform_workflow_shas = [
    "625efd11af9fd3b7f4d0ca972475173d5b25a472",
  ]
