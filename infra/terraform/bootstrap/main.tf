module "bootstrap" {
  source = "github.com/collinbentley1/platform//terraform/modules/bootstrap?ref=6b2b20fa6cb61ed68e682fbcec14d8bab68a3623"
  ...
  trusted_platform_workflow_shas = [
    "6b2b20fa6cb61ed68e682fbcec14d8bab68a3623",
  ]
