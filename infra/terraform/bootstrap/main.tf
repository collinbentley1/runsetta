module "bootstrap" {
  source = "github.com/collinbentley1/platform//terraform/modules/bootstrap?ref=9d6132795f01b90be532c807c672ed017588e18f"
  ...
  trusted_platform_workflow_shas = [
    "9d6132795f01b90be532c807c672ed017588e18f",
  ]
