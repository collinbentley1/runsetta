module "bootstrap" {
  source = "github.com/collinbentley1/platform//terraform/modules/bootstrap?ref=ebdc8e84e1a563db09cc8a953e90f82cdc4c1de9"
  ...
  trusted_platform_workflow_shas = [
    "ebdc8e84e1a563db09cc8a953e90f82cdc4c1de9",
  ]
