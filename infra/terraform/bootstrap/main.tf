module "bootstrap" {
  source = "github.com/collinbentley1/platform//terraform/modules/bootstrap?ref=af5174302407286cffa30d5b7721053b5295ee57"
  ...
  trusted_platform_workflow_shas = [
    "af5174302407286cffa30d5b7721053b5295ee57",
  ]
