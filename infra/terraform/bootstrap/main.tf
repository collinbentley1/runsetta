module "bootstrap" {
  source = "github.com/collinbentley1/platform//terraform/modules/bootstrap?ref=378116420ea2b48c5bb9dbb4cd42244a2f99c3db"
  ...
  trusted_platform_workflow_shas = [
    "378116420ea2b48c5bb9dbb4cd42244a2f99c3db",
  ]
