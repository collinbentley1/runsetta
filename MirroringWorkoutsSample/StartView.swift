...
struct StartView: View {
    ...
    @State private var navigateToAudioContentView = false
    ...
    var body: some View {
        NavigationStack {
            VStack {
                ...
                // Button to navigate to AudioContentView
                Button("Go to Audio Player") {
                    navigateToAudioContentView = true
                }
                .padding()
                ...
                // Button to navigate to ViewController (spotify)
            ...
            .navigationDestination(isPresented: $navigateToViewController) {
                ViewControllerWrapper()
            }

            .navigationDestination(isPresented: $navigateToAudioContentView) {
                AudioContentView()
            }
